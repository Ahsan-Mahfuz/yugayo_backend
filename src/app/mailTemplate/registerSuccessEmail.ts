const registrationSuccessEmailBody = (name: string, activationCode: number) => `
  <html>
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to GAU University</h1>
        </div>
        <div class="content">
          <h2>Hello, ${name}</h2>

          <p>Thank you for registering with GAU University . To activate your account, please use the following activation code:</p>
          ...
          <p>If you have any questions, feel free to contact us at <a href="info@cravecrusher.com">info@gau.com</a>.</p>
        </div>
        <div class="footer">
